...
class MSRB(nn.Layer):
    def __init__(self, conv=arch_util.default_conv, n_feats=64):
    ...
    def forward(self, x):
        ...
        input_2 = paddle.concat([output_3_1, output_5_1], 1)
        output_3_2 = self.relu(self.conv_3_2(input_2))
        output_5_2 = self.relu(self.conv_5_2(input_2))
        input_3 = paddle.concat([output_3_2, output_5_2], 1)
        output = self.confusion(input_3)
        output += x
        return output

class MSRN(nn.Layer):
    def __init__(self, scale, conv=arch_util.default_conv):
        ...
        modules_tail = [
            ...
            arch_util.Upsampler(conv, scale, n_feats, act=False),
